    ...
    <ScrollView>
      <View style={styles.container}>
        <View style={styles.buttonContainer}>
          <TouchableOpacity style={styles.buttonStyle} onPress={() => navigation.navigate('AddBabyVaccine', { data })}>
        ...
        <View style={styles.progressBarContainer}>
          ...
          <View style={styles.progressBarText}>
            ...
            <Text style={styles.vaccineCountText}>
              {vaccinePercentage}% of the baby's vaccination process is complete.
            </Text>
          </View>
          <ProgressBar
